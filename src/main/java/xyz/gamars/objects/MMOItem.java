...
public class MMOItem {
    ...
    public String toString() {
        return "MMOItem{" +
                ...
                ", gemColor='" + gemColor + '\'' +
                ", gemUpgradeScaling='" + gemUpgradeScaling + '\'' +
                ...
                ", breakDowngrade=" + breakDowngrade +
                ", deathDowngrade=" + deathDowngrade +
                ", deathDowngradeChance=" + deathDowngradeChance +
